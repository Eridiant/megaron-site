...
<div id="menu" class="menu">
    <div class="menu-wrapper">
        <div class="menu-header">
            <a href="{{route('index')}}" class="icon"><svg><use xlink:href="/images/icons.svg#logo"></use></svg></a>
        ...
        <nav class="nav">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item"><a href="{{route('news')}}"><?= __('messages.news'); ?></a></li>
                <li class="menu-item sub">
                ...
                <li class="menu-item"><a href="{{route('index')}}"><?= __('messages.new_building'); ?></a></li>
                <li class="menu-item"><a href="{{route('contacts')}}"><?= __('messages.contacts'); ?></a></li>
            </ul>
        </nav>
